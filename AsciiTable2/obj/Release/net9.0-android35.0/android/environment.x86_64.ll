...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 u0x06001b8b, ; uint32_t jnienv_initialize_method_token
	i32 u0x06001b8a, ; uint32_t jnienv_registerjninatives_method_token
...
@aot_dso_cache = dso_local local_unnamed_addr global [855 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.25_name, ; name: libaot-Plugin.MauiMtAdmob.dll.so
		ptr null; void* handle
	}, ; 37
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.29_name, ; name: libaot-Xamarin.AndroidX.Browser.dll.so
		ptr null; void* handle
	}, ; 57
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x12e79e472738cc62, ; from name: libaot-AsciiTable
		i64 u0xdc24a2d6b14d4e68, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-AsciiTable.dll.so
		ptr null; void* handle
	}, ; 74
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x1764c572d079b92a, ; from name: aot-AsciiTable.so
		i64 u0xdc24a2d6b14d4e68, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-AsciiTable.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x1f141c8e14be7f73, ; from name: aot-AsciiTable
		i64 u0xdc24a2d6b14d4e68, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-AsciiTable.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x1f805b664af6abd5, ; from name: libaot-AsciiTable.so
		i64 u0xdc24a2d6b14d4e68, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-AsciiTable.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xbfd3dcde458406f0, ; from name: aot-AsciiTable.dll.so
		i64 u0xdc24a2d6b14d4e68, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-AsciiTable.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xd17bdd2471576927, ; from name: AsciiTable.dll.so
		i64 u0xdc24a2d6b14d4e68, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-AsciiTable.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xdc24a2d6b14d4e68, ; from name: libaot-AsciiTable.dll.so
		i64 u0xdc24a2d6b14d4e68, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-AsciiTable.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xf1015c8699efef29, ; from name: AsciiTable.so
		i64 u0xdc24a2d6b14d4e68, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-AsciiTable.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xf2e9fabca7a6f5ab, ; from name: AsciiTable
		i64 u0xdc24a2d6b14d4e68, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-AsciiTable.dll.so
		ptr null; void* handle
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [25 x i8] c"libaot-AsciiTable.dll.so\00", align 16
...
@.DSOCacheEntry.25_name = private unnamed_addr constant [33 x i8] c"libaot-Plugin.MauiMtAdmob.dll.so\00", align 16
...
@.DSOCacheEntry.29_name = private unnamed_addr constant [39 x i8] c"libaot-Xamarin.AndroidX.Browser.dll.so\00", align 16
